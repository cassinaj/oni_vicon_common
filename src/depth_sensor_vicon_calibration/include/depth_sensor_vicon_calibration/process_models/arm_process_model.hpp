#ifndef POSE_FILTER_ARM_PROCESS_MODEL_
#define POSE_FILTER_ARM_PROCESS_MODEL_
...
class ArmProcessModel: public ProcessModel
{
public:
	ArmProcessModel(float angle_sigma, float trans_sigma, Eigen::Vector3f rot_center);
	virtual ~ArmProcessModel();
