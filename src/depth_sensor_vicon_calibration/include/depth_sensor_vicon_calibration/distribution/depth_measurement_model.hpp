...
namespace distr
{
            ...
            public MeasurementModelBase<measurement_dim, state_dim, noise_dim>
    {
        private:
            ...
            typedef DepthMeasurementModel<measurement_dim, state_dim, noise_dim>   this_type;
        ...
        public: /* MeasurementModel */
            ...
            virtual const NoiseCovariance& noiseCovariance(const MeasurementVector& mean_measurement)
            {
                if (dirtyCov)
                {
                    ...
                    */
                    ...
                    mask_.resize(noise_covariance.rows(), 1);
                    mask_.setZero();
            ...
            virtual MeasurementVector& mask()
            {
                mask_.resize(noise_covariance.rows(), 1);
                mask_.setZero();
